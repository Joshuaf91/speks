  ...
  render: function() {
    return (
      <div>
        ...
        <img id="home-image" src="https://i.warbycdn.com/v/c/assets/eyeglasses-sunglasses/image/Fall-2016-eyeglasses-desktop/0/1a50f7bdf7.jpg?quality=80&width=1300" alt="Speks"/> {/* I really wanted for this to be a slider & not just a singular image, still working on figuring out the slider, if any one knows how to do so it would be helpful, until then I'll keep working on it!*/}
        <h3>Product</h3>
        	<div className='row'>
